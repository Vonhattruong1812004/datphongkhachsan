...
--
-- Name: loaicosoluutru; Type: TABLE; Schema: abc_resort1; Owner: -
--

CREATE TABLE abc_resort1.loaicosoluutru (
    maloai integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ma character varying(40) NOT NULL UNIQUE,
    tenloai character varying(80) NOT NULL,
    mota text,
...
--
-- Name: diadiemdulich; Type: TABLE; Schema: abc_resort1; Owner: -
--

CREATE TABLE abc_resort1.diadiemdulich (
    madiadiem integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    tendiadiem character varying(180) NOT NULL,
    slug character varying(180) NOT NULL UNIQUE,
    tukhoa text,
    tinhthanh character varying(100),
    quanhuyen character varying(100),
    diachi character varying(255),
    loaihinh character varying(80),
    motangan text,
    vido numeric(10,7),
    kinhdo numeric(10,7),
    hinhanh character varying(255),
    trangthai character varying(30) DEFAULT 'HoatDong'::character varying NOT NULL,
    ngaytao timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


--
-- Name: khachsan_diadiem; Type: TABLE; Schema: abc_resort1; Owner: -
--

CREATE TABLE abc_resort1.khachsan_diadiem (
    id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    makhachsan integer NOT NULL,
    madiadiem integer NOT NULL,
    khoangcachkm numeric(6,2) DEFAULT 0 NOT NULL,
...
CREATE INDEX diadiemdulich_search_idx ON abc_resort1.diadiemdulich USING btree (trangthai, tinhthanh, slug);
CREATE INDEX khachsan_diadiem_hotel_idx ON abc_resort1.khachsan_diadiem USING btree (makhachsan, khoangcachkm);


--
-- Name: goidulich; Type: TABLE; Schema: abc_resort1; Owner: -
--

CREATE TABLE abc_resort1.goidulich (
    magoi integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    tengoitour character varying(180) NOT NULL,
    slug character varying(180) NOT NULL UNIQUE,
    madiadiem integer,
    makhachsan integer,
    diemkhoihanh character varying(180),
    loaitour character varying(80) DEFAULT 'Tham quan'::character varying NOT NULL,
    thoiluong character varying(80) NOT NULL,
...
--
-- Name: yeucautour; Type: TABLE; Schema: abc_resort1; Owner: -
--

CREATE TABLE abc_resort1.yeucautour (
    mayeucau integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    magoi integer NOT NULL,
    makhachhang integer,
    hoten character varying(150) NOT NULL,
    sdt character varying(24) NOT NULL,
    email character varying(150),
    ngaydi date,
    songuoi integer DEFAULT 1 NOT NULL,
    ghichu text,
    trangthai character varying(30) DEFAULT 'Moi'::character varying NOT NULL,
    ngaytao timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


CREATE INDEX goidulich_filter_idx ON abc_resort1.goidulich USING btree (trangthai, loaitour, douutien DESC, gia);
CREATE INDEX goidulich_destination_idx ON abc_resort1.goidulich USING btree (madiadiem, makhachsan);
CREATE INDEX yeucautour_status_idx ON abc_resort1.yeucautour USING btree (trangthai, ngaytao DESC);
...
CREATE TABLE abc_resort1.khuyenmai (
    ...
    magiamgia character varying(40),
    tenchuongtrinh character varying(150) NOT NULL,
    ngaybatdau date,
    ngayketthuc date,
    mucuudai numeric(12,2) DEFAULT 0.00,
    doituong text,
...
CREATE UNIQUE INDEX idx_khuyenmai_magiamgia ON abc_resort1.khuyenmai USING btree (magiamgia) WHERE (magiamgia IS NOT NULL);
